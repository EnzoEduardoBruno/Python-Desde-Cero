from ETAPA_1_programacion_secuencial.M08_Listas.practica import *
...
try:
    validar(5, ejercicio_5(), ["rojo", "azul"])
except Exception as error:
    incorrecto(5, error)


try:
    validar(6, ejercicio_6(), ["rojo", "verde", "azul"])
except Exception as error:
    incorrecto(6, error)
...
try:
    validar(8, ejercicio_8(), [0, 1, 2, 3, 4])
except Exception as error:
    incorrecto(8, error)


try:
    validar(9, ejercicio_9(), True)
except Exception as error:
    incorrecto(9, error)


try:
    validar(10, ejercicio_10(), ["Python", "TypeScript", "JavaScript", "C#"])
except Exception as error:
    incorrecto(10, error)
